...
class ArticleModel extends BaseModel{
    ...
    public function addData(){
        ...
        if(!empty($image_title_alt_word)){
            // 修改图片默认的title和alt
            $data['content']=preg_replace('/title=\"(?<=").*?(?=")\"/','title="鹿晓鹏博客"',$data['content']);
            $data['content']=preg_replace('/alt=\"(?<=").*?(?=")\"/','alt="鹿晓鹏博客"',$data['content']);
        }
        // 将绝对路径转换为相对路径
        ...
        if($this->create($data)){
            ...
            if($aid=$this->add()){
                ...
                {
                    case 33:
                        $image_path[] = '/Upload/image/ueditor/python.jpg';
                        break;
                    case 32:
                        $image_path[] = '/Upload/image/ueditor/php.jpeg';
                        break;
                    case 31:
                        $image_path[] = '/Upload/image/ueditor/gongju.jpeg';
                        break;
                    case 30:
                        $image_path[] = '/Upload/image/ueditor/git.jpeg';
                        break;
                    case 29:
